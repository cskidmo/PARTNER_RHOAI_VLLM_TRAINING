...
Follow this guide (https://ai-on-openshift.io/tools-and-applications/minio/minio/#create-a-bucket) to set up minio but name the minio bucket "guidellm-benchmark" instead of "mybucket"
